...
if (isset($_POST['login'])) {
    ...
    if ($query->rowCount() > 0) {
        foreach ($results as $result) {
            ...
            $_SESSION['role'] = $result->AdminName;
            $_SESSION['wisata'] = $result->MobileNumber;
...
if (isset($_POST['reset_password'])) {
    ...
    $newpassword = md5($_POST['reset_newpassword']);
...
<body>
    <div class="login-container">
        ...
        <form method="post">
            ...
            <a href="#" 
               onclick="if(confirm('Silakan menghubungi admin untuk melakukan reset password.\n\nLanjutkan ke form reset password?')) { document.getElementById('resetModal').style.display='block'; } return false;" 
