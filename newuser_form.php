...
if (!empty($_POST["fullname"])) {
    ...
    $sql = "SELECT UserName FROM users WHERE UserName=:fullname";
    ...
    if ($query->rowCount() > 0) {
        ...
        if (isset($_POST['signup'])) {
            ...
            $sql = "INSERT INTO  users(Staffid,AdminName,UserName,FirstName,LastName,Email,MobileNumber,Password) VALUES(:staffid,:dignity,:fname,:firstname,:lastname,:email,:mobile,:password)";
            $query = $dbh->prepare($sql);
