...
if (isset($_GET['delid'])) {
    ...
    $sql = "UPDATE users SET Status='0' WHERE ID = :rid";
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                ...
                                <div class="card-body table-responsive p-3">
                                    ...
                                    <?php
                                    $countSql = "SELECT COUNT(*) AS total FROM users WHERE Status='1'";
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class=" text-center">
                                                            ...
                                                            <a href="userregister.php?delid=<?php echo ($row->ID); ?>" onclick="return confirm('Do you really want to Delete ?');" title="Delete this User"><i class="mdi mdi-delete fa-delete" style="color: #f05050" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                            <?php $cnt = $cnt + 1;
                                                }
